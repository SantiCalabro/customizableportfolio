...
export default function FormField({label, fieldType, id, placeholder, width, styles}) {
  return (
    <div className={`flex flex-col ${width && width} ${styles && styles}`}>
        ...
        {fieldType === 'textarea' ?  <textarea name={id} id={id} className="focus:outline-none white p-3 text-sm border-primary-gray rounded-xl bg-gray-opacity w-full"></textarea> : 
